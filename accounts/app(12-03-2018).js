        ...
        $scope.doLogin = function () {
            ...
            /*else if($scope.usertype == undefined || $scope.usertype =="blank")
            {
                ...
                iziToast.error({title: 'Error',message: "Please select user type", position: 'bottomLeft'});
                        ...
                        $scope.loading = true;
                    $http.post("https://espl.in.net/api/doLogin",userData)
...
/*
 ...
 //var param=JSON.stringify({});
  /*          var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;*/
            $http.get("https://espl.in.net/api/getStudentListforrfids")
                .success(function (data) {
            ...
            $http.get("https://espl.in.net/api/getrfidforassignment")
                .success(function (data) {
          ...
          $scope.assignRFID = function () {
            ...
            $http.post("https://espl.in.net/api/assignRFID",param)
                .success(function (data) {
 ...
 //var param=JSON.stringify({});
  /*          var name = localStorage.batchname;
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getallbranches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getcoursesnew",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.shiftBatch=function(){
            ...
            var flag = confirm("Do You Really Want To Shift Batch ");
                if (flag == true) 
                {
                    ...
                    $scope.loading = true;
                    $http.post("https://espl.in.net/api/shiftBatch",batchparam)
                            .success(function (data) {
                                if (data.success == "true") {
                                    ////console.log(data);
                    ...
                    $http.post("https://espl.in.net/api/shiftBatchStudent",studparam)
                            .success(function (data) {
                                $scope.loading = false;
                                if (data.success == "true") {
    ...
    {
        $http.post("https://espl.in.net/api/getcityadmin")
        .success(function(data){
    ...
    $scope.addCityAdmin = function()
    {
        ...
        $http.post("https://espl.in.net/api/ad",datatosend)
        .success(function(data){
            toastr.success(data.message);
            $scope.getCities();
    ...
    else if($scope.b['branchname']==undefined || $scope.b['branchname']=="")
    {
        iziToast.error({title: 'Error',message: "Please Enter Branch Name!", position: 'bottomLeft'});
         ...
         iziToast.error({title: 'Error',message: "Please Enter Branch Contact!", position: 'bottomLeft'});
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/addbranch",datatosend)
            .success(function(data){
                $scope.loading = false;
...
/*    $scope.getCities = function()
    {
        $scope.loading = true;
        $http.get("https://espl.in.net/api/getcities")
        .success(function(data){
            $scope.loading = false;
           // toastr.success(data.message);
           if(data.success == "true")
     ...
     $scope.addCity = function() {
        ...
        //console.log(datatosend);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/addcity",datatosend)
        .success(function(data){
            $scope.loading = false;
            //toastr.success(data.message);
            $scope.getCities();
...
*/
    ...
    $scope.result={};
       ...
       var param=JSON.stringify({"data":data})
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getfeestructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.loading = true;
        $http.post("https://espl.in.net/api/FeeStructure")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
 ...
 $scope.result1={};
        ...
        $scope.getCities = function () 
      {
         ...
         $scope.getStudentInfo = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getStudentInfo",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getBoard",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     //console.log("");
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getBatch",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.getbatchesnew = function (id) {
    ...
    $scope.getCourses = function (id) {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getcourse",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     $scope.getBatches = function (name,id) {
        ...
        //console.log(param);
        $scope.loading = true;
       $http.post("https://espl.in.net/api/getBatches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getStaffNames = function () 
      {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/api/getstaffnames")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.templist={};
    ...
    $http.get("https://espl.in.net/api/getsmsStudentList")
    ...
    $scope.editBranch = function(branchtoupdate)
{
 ...
 $scope.updateBranch = function() {
    ...
    }else
    {
        ...
        //console.log(datatosend);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/updatebranch",datatosend)
        .success(function(data){
            $scope.loading = false;
            //console.log(data);
...
$scope.addBatch = function(branchid)
{
     if($scope.c['std']==undefined || $scope.c['std']=="")
    {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getsinglebranch",param)
        .success(function(data){
        $scope.loading = false;
        ...
        $http.post("https://espl.in.net/api/addbatchnew",datatosend)
        .success(function(data){
      ...
      { 
        ...
        else if($scope.usertype == "1" && $scope.branchid == undefined)
        {
          ...
          var userData = JSON.stringify({
            ...
            $http.post("https://espl.in.net/api/testUserExistence",userData)
            .success(function(data){
              if(data.success == "true")
              {
        alert('User Already Exists');             }
              else{
      $http.post("https://espl.in.net/api/insertuser",userData)
            .success(
                function (data) {
                    $scope.loading = false;
                        if (data.success === "true") {
                           ...
                           var smsdata = JSON.stringify({"mobile":$scope.mobile,"msg":msg});
                            $http.post("https://espl.in.net/api/sendsms",smsdata)
                            .success(function (data) {
                                if(data.success=="true")
                                {
                                    iziToast.show({theme: 'dark',title:'Success',message:"sms sent",position: 'bottomLeft',icon: 'fa fa-user',progressBarColor: 'rgb(0, 255, 184)'});
...
$scope.getTeachersLogin=function()
    {
        $scope.loading=true;
        $http.post("https://espl.in.net/api/getTeachers")
        .success(function(data){
           if(data.success == "true")
           {
    ...
    //console.log("Inside Delete Teacher");
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/api/deleteTeacher",param)
                .success(function (data) {
                    $scope.loading = false;
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/api/deleteuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/api/deactivateuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/api/activateuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
    ...
    {
        $scope.loading=true;
        $http.post("https://espl.in.net/api/getusers")
        .success(function(data){
           // toastr.success(data.message);
           if(data.success == "true")
           {
       ...
       // toastr.error("Something went wrong! Please try again...");
        ...
        $scope.getUsertypes = function() {
            //console.log("get staff names func");
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getusertypes")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
         ...
         $scope.testRegistered=function()
        {
            ...
            if ($scope.mobile && $scope.utype)
                {
                    $http.post("https://espl.in.net/api/registeredMobile",param)
                        .success(function (data) {
                            if (data.success == "true" ) {
...
$scope.toggleEditableResult = function(){
        ...
        else 
        {
           ...
           //console.log("IN function create result");
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/createbatchresult",batchdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteResult = function(id)
    {
        ...
        if (flag == true) 
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deleteresult",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    {
        $scope.loading = true;
            $http.post("https://espl.in.net/api/gettests")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getresultforstudent = function(batch) {
        //console.log(batch);
            ...
            //console.log(param);
            $http.post("https://espl.in.net/api/getresultforstudent",param)
                .success(function (data) {
                    if (data.success == "true") {
    ...
    $scope.getTestResultData =function()
    {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/api/gettestresult",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.submitResult = function(){
        ...
        $scope.loading = true;
        //console.log(param);
        $http.post("https://espl.in.net/api/updatetestresult",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
     ...
     $scope.getBatchforBranchLogin =function ()
       ...
       $scope.batchforattendance = function (batchname) {
           ...
           /* var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("https://espl.in.net/api/getbatchattendance",param)
                .success(function (data) {
...
riddlerApp.controller('studentController', function($scope,$http,Upload,$window,$location,$route,$filter,$rootScope, idService) {
    ...
    $scope.getstd = function(board) {
        ...
        $http.post("https://espl.in.net/api/getstd",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log(data);
...
/*$scope.checkAllStudents = function()
    ...
    $scope.addstudentattendance = function()
    {
       ...
       angular.forEach($scope.studentList, function(student) {
                ...
                //console.log(param);
            $http.post("https://espl.in.net/api/studentattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    //console.log(data);
                    if (data.success == "true") {
    ...
    $scope.deleteStudent=function(){
        ...
        var param =JSON.stringify({"studId":$scope.studentInfo[0]._id})
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deletestudent",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     $scope.getStaffList = function () 
      {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/api/getstafflist",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getSubjects = function (batchname) 
      {
            ...
            $scope.topic="";
            $scope.topics={};
            $http.post("https://espl.in.net/api/getsubjectforbatches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.getTopics = function (batchname,subj) 
      {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/gettopicsforsubject",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.changepwd = function() {
        ...
        //console.log(param);
        $http.post("https://espl.in.net/api/changepwd",param)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
                     $scope.loading=false;
    ...
    $scope.savepdf = function(name,foldername){
        ...
        pdfDocGenerator.getBase64((data) => {  //alert(data);
            var pdfdata = JSON.stringify({"pdfdata":data,"pdfname":name,"foldername":foldername});
              // //console.log(pdfdata);
            $http.post("https://espl.in.net/api/createpdf",pdfdata)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
    ...
    for (var x = 0; x < dCount; x++) 
        ...
        if (paymentFlag == 1) 
        {
           ...
           $http.post("https://espl.in.net/api/editstudentinfo",param)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
                     $scope.studentInfo=data.studentdata;
     ...
     $scope.getproduct = function(board)
  {
    ...
    $scope.getenqiryperson = function (enid) {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getenqiryperson",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.getBatch = function (branchname,board) {
  ...
  $scope.selectedMonthFilter = function(element) {
    ...
    $scope.getterms=function()
    {
        //console.log("terms");
        $scope.loading = true;
         $http.post("https://espl.in.net/api/getterms")
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/api/addnewenquirystudent", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
    ...
    $scope.deleteEnquiry = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deleteenquiry",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
$scope.loading = true;
        $http.post("https://espl.in.net/api/addstudentdirectly", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
...
$scope.loading = true;
        $http.post("https://espl.in.net/api/addnewstudent", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
    ...
    $scope.getEnquiryStudentList = function () {
        ...
        $http.post("https://espl.in.net/api/getEnquiryStudentList",param)
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
    ...
    $scope.getAdmittedStudentList = function () {
         $scope.loading = true;
        $http.post("https://espl.in.net/api/getAdmittedStudentList")
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
    ...
    $scope.geteditdata = function () {
        //    //console.log("in fun");
          ...
          // localStorage.clear();
           ...
           $scope.loading = true;
            $http.post("https://espl.in.net/api/getAdmittedStudentList",studentData)
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
  ...
  delete($scope.studentInfo[0].payment[""+i]);
        ...
        $scope.getStudentsForAttendance = function (batchname) {
           ...
           /* var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("https://espl.in.net/api/getstudentslistforattendance",param)
                .success(function (data) {
        ...
        $scope.getStudents = function () {
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("https://espl.in.net/api/getAdmittedStudentList",param)
                .success(function (data) {
...
/*$scope.getSchools = function () {
            $http.post("https://espl.in.net/api/getSchoolsList")
                .success(function (data) {
                    if (data.success == "true") {
                        //console.log(data);
...
/*            //console.log("hello");
            ...
            //console.log(userData);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getschoolstudlist",userData)
               .success(function (data) {
                $scope.loading = false;
                    if (data.success == "true") {
                    //console.log(data);
      ...
      $scope.getfeedata = function(productid){
            ...
            $http.post("https://espl.in.net/api/getfeedata",productdata)
               .success(function (data) {
                    if (data.success == "true") {
        ...
        $scope.transferStudent = function()
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/transferStudent",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getcoursesbycity = function () {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getcoursesbycity",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.uploadtestfile = function() {
            ...
            var uploadUrl = "https://espl.in.net/api/uploadquestionpaper";
            ...
            var uploadUrl = "https://espl.in.net/api/uploadTimetable";
            ...
            var uploadUrl = "https://espl.in.net/api/uploadTimetableportion";
    ...
    else if($scope.testtimetableportionlink == undefined || $scope.testtimetableportionlink == "")
    {
        iziToast.error({title: 'Error',message: "Please Select Timetable Portion File To Upload!", position: 'bottomLeft'});
            ...
            $http.post("https://espl.in.net/api/uploadTestTimetable",parameter)
            .success(function(data) {
            waitingDialog.hide();
            if (data.success == "true") {
...
*/
    ...
    else if($scope.testnamefortest == undefined)
    {
        iziToast.error({title: 'Error',message: "Please Enter Test Name!", position: 'bottomLeft'});
            ...
            $http.post("https://espl.in.net/api/uploadTest",parameter)
            .success(function(data) {
            waitingDialog.hide();
            if (data.success == "true") {
                iziToast.success({title: 'Error',message: data.message, position: 'bottomLeft'});
    ...
    $scope.deleteTest = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deletetest",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.gettesttimetable = function () {
        $scope.loading = true;
        $http.post("https://espl.in.net/api/gettesttimetable")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getquestionpapers = function () {
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getquestionpapers")
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getquestionpaperforstudent = function(batch) {
            ...
            $http.post("https://espl.in.net/api/getquestionpaperforstudent",formdata)
                .success(function (data) {
                    if (data.success == "true") {
...
$scope.getcurrentcitystaff = function(cityid)
    {
        ...
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getCurrentCityName",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
 ...
 $scope.days=['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'];
    $scope.getTodaysTime=function (){
        ...
        $http.post("https://espl.in.net/api/getTodaysDate")
                        .success(function (data) {
                            if (data.success == "true") {  
                                //console.log(data);  
...
var i=0
  ...
  delete($scope.staffInfo[0].salarydetails.contractlist[""+i]);*/
    ...
    $scope.getStaffInfo = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getStaffInfo",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    /*  if(staffdata.salarydetails.length==undefined)
      ...
      //console.log(staffdata);
        ...
        //console.log(param);
        $scope.loading = true;
         $http.post("https://espl.in.net/api/editstaffinfo",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            $scope.staffInfo=data.staffdata;  
         ...
         $scope.getTeachertimetable = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getteachertimetable",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getStaffAttendancedetails = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getstaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
...
//console.log("get emplyee attendance details called");
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getstaffpayment = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/api/summarypayment",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    alert (minutes+' minutes.');
      ...
      /*  var a = moment.duration(start, 'H');
        ...
        //$location.path('adminDashboard');
    $scope.loading = true;
    $http.post("https://espl.in.net/api/addstaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data.staff);
...
$scope.saveEmployeeAttendance = function () {
        ...
        //$location.path('adminDashboard');
        $scope.loading = true;
        $http.post("https://espl.in.net/api/addemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
   ...
   $scope.saveupdatedAttendance=function(){
    ...
    //console.log($scope.updatedata);
        ...
        */
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/updatestaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    //console.log("success");
    ...
    //console.log($scope.employeedata);
        ...
        */
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/updateemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.getEmployeeList = function () 
      {
        ...
        //console.log('city stafflist :'+param);
        $scope.loading = true;
            $http.post("https://espl.in.net/api/getemployeelist",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getSubjects = function (batchname) 
        ...
        $scope.getTopics = function (batchname,subj) 
      {
         ...
         $scope.getStaffDetails = function () {
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getBranchStaffList")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.insertStaff = function (id) {    
    ...
    var staffData = JSON.stringify({"staffdata":$scope.stafflist});
        ...
        $scope.loading = true;
        waitingDialog.show("...Please Wait");
        $http.post("https://espl.in.net/api/addstaff", staffData)
            .success(
                function (data) {
                    $scope.loading = false;
                        if (data.success === "true") {
...
/*
    ...
    $scope.deleteStaff = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deletestaff",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
riddlerApp.controller('rfidController', function($scope,$http,$window) 
{
    ...
    {
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getBatches")
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    $scope.getRfidList = function(){
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getassignedrfid",param)
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    $scope.saveRfidList = function()
    {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/updaterfidlist",param)
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
...
riddlerApp.controller('feesController', function($scope,$http,$window,$location,$route) 
{
    ...
    $scope.getCount = function(){
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("https://espl.in.net/api/feereportcount")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
   ...
   /*  param=JSON.stringify({"data":feesdata});
      ...
      $scope.loading = true;
    $http.post("https://espl.in.net/api/FeeStructure",feesdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
   ...
   var feesdata=JSON.stringify({"id":productid});
    ...
    $scope.exportDiscount=function(name = '')
    {
     ...
     $scope.insertnewstructure = function () {
        ...
        //console.log(param);
       $scope.loading = true;
    $http.post("https://espl.in.net/api/insertnewstructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                     iziToast.show({theme: 'dark',title:'Success',message: data.message,position: 'bottomLeft',icon: 'fa fa-user',progressBarColor: 'rgb(0, 255, 184)'});  
    ...
    {
        $scope.loading = true;
      $http.post("https://espl.in.net/api/getallbranches")
        .success(function(data){
           // toastr.success(data.message);
           $scope.loading = false;
           if(data.success == "true")
  ...
  $scope.getBatch = function (branchname,board) {
   ...
   $scope.getClassFee = function () {
        ...
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getclassfeetructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
/*       data={};
    ...
    //console.log(param);
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/api/updatefeeinfo",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteFeeStructure = function(fee_id)
    {
        ...
        if (flag == true) 
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deletefeestructure",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
riddlerApp.controller('scheduleController', function($scope,$http,$window,$location,$route) 
{
    ...
    $scope.countDashboard = function()
    {
        ...
        $http.post("https://espl.in.net/api/countDashboard")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log(data);
    ...
    $scope.editYearlySchedulebatch = function(){
        ...
        //waitingDialog.show('...Please Wait');
        $scope.loading = true;
        $http.post("https://espl.in.net/api/editYearlySchedulebatch",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.submitYearlySchedule = function(){
        ...
        //waitingDialog.show('...Please Wait');
        $scope.loading = true;
        $http.post("https://espl.in.net/api/editYearlySchedule",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.getSchedules = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getSchedules")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getSchedules",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $http.post("https://espl.in.net/api/getColors")
    ...
    $scope.getdashschedule = function () {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/api/getdashschedule",formdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        $http.post("https://espl.in.net/api/getColors")
    ...
    $scope.createSchedule = function(){
        ...
        else 
        {
           ...
           //waitingDialog.show('...Please Wait');
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/createschedule",scheduleDates)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteSchedule = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deleteschedule",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
     ...
     $scope.addcolor = function(){
      ...
      $scope.loading = true;
        $http.post("https://espl.in.net/api/addColor",colorData)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $route.reload();
    ...
    $scope.createTimetable = function() {
        ...
        //console.log(ttData);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/createtimetable",ttData)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            //console.log(data);
    ...
    $scope.newcreateTimetable = function() {
        ...
        //console.log(ttData);
        $scope.loading = true;
        $http.post("https://espl.in.net/api/chktimetableexist",ttData)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                                          $http.post("https://espl.in.net/api/newcreatetimetable",ttData)
                                        .success(function (data) {
                                            $scope.loading = false;
                                            if (data.success == "true") {
                                                //console.log(data);
      ...
      /*  $scope.allsyll[0].syllabus.subject.splice(localStorage.subjectindex, 1); 
        ...
        //console.log("param");
        //console.log(param);
        $http.post("https://espl.in.net/api/editDailyTimetable",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
        ...
        $scope.getmo=function(param,msg){
                    $http.post("https://espl.in.net/api/getteachermobile",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            console.log(data);
                        $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+msg+'&senderId=MTEDUC&routeId=1&mobileNos='+data.mobile+'&smsContentType=english')
                        .success(function (data) {
                            if (data.responseCode == "3001") {
...
/*          var startTime=moment($scope.newtt[index].stime, "HH:mm a");
    ...
    $scope.getTimetable = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getTimetable")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.alltt = data.timetables;
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getTimetable",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    /*$http.post("https://espl.in.net/api/getColors")
    ...
    $scope.newgetTimetable = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/newgetTimetable")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.alltt = data.timetables;
            ...
            var id = JSON.stringify({"id":localStorage.timetableID});
            $scope.loading = true;
            $http.post("https://espl.in.net/api/newgetTimetable",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    /*$http.post("https://espl.in.net/api/getColors")
    ...
    $scope.gettodaystimetable = function ()
    {
        ...
        $http.post("https://espl.in.net/api/gettodaystimetable",formdata)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log(data);
            ...
            .success(function (data) {
                ...
                if (data.success == "true") {
                    ...
                    if (data.overlap == "false") {
                        ...
                        //console.log(param2);
                        $http.post("https://espl.in.net/api/updatetimetable",param2)
                            .success(function (data) {
                            if (data.success == "true") {
                            //console.log("success");
                            /*//console.log(data);
    ...
    $scope.getBoard = function () {
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getBoard")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.createSyllabus = function() {
      ...
      var param = JSON.stringify({'syllName': $scope.syllName,'syllyear': $scope.syllyear});
        $scope.loading = true;
        $http.post("https://espl.in.net/api/createSyllabus",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            ////console.log(data);
    ...
    $scope.deleteSyllabus = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deletesyllabus",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.deleteTimeTable = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/api/deletetimetable",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.getSyllabus = function(id = '') {
      ...
      if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getSyllabus")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getSyllabus",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
...
/*    $scope.subject = [];*/
    ...
    $scope.savesyllabus=function()
    {
        ...
        var syllabusdata = JSON.parse(angular.toJson({"syllabus":$scope.syll}));
            ...
            $http.post("https://espl.in.net/api/updatesyllabus",syllabusdata)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.getsyllabusname = function()
    {
        console.log("inside getsyllabusname");
         $http.post("https://espl.in.net/api/getsyllabusname")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.createdailyreport = function()
    {
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/api/createdailyreport",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == 'true') {
    ...
    $scope.getdailyreport = function(id = '') {
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getdailyreport")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/api/getdailyreport",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    {
       $http.get("https://espl.in.net/api/getdailyreportcolor")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.lecturerecord = function ()
    {
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/api/getlecturedetails",senddata)
            .success(function(data){
                $scope.loading = false;
           if(data.success == "true")
           {

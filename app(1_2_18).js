  ...
  return {
    ...
    riddlerApp.directive('loading', function () {
      return {
        restrict: 'E',
        replace:true,
        template: '<div class="loading"><img src="assets/images/load.gif" width="70" height="70" /></div>',
        ...
        $scope.doLogin = function () {
            ...
            /*else if($scope.usertype == undefined || $scope.usertype =="blank")
            {
                ...
                iziToast.error({title: 'Error',message: "Please select user type", position: 'bottomLeft'});
                        ...
                        $scope.loading = true;
                    $http.post("http://139.59.4.32:5128/doLogin",userData)
            ...
            bothsmslist=bothsmslist+checkedSmsList[checkedSmsList.length-1].studentMobile; 
             mobilenos=bothsmslist
                ...
                //console.log(mobilenos);
                   ...
                   /* $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+$scope.sms+'&senderId=MTEDUC&routeId=1&mobileNos='+mobilenos+'&smsContentType=english')
                    .success(function (data) {
...
/*
    $scope.checkAllStudents = function()
    {
        ...
        {
        $scope.studentList.isChecked = true;   
        }
    };*/
    ...
    $scope.unCheckStudents = function ()
    {
    	for (var i = 0; i < $scope.studentList.length; i++) 
        {
        $scope.studentList.isChecked = false;   
        }
    };
 ...
 //var param=JSON.stringify({});
  /*          var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;*/
            $http.get("http://139.59.4.32:5128/getStudentListforrfids")
                .success(function (data) {
            ...
            $http.get("http://139.59.4.32:5128/getrfidforassignment")
                .success(function (data) {
          ...
          $scope.assignRFID = function () {
            ...
            $http.post("http://139.59.4.32:5128/assignRFID",param)
                .success(function (data) {
 ...
 //var param=JSON.stringify({});
  /*          var name = localStorage.batchname;
        ...
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getallbranches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getcoursesnew",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.shiftBatch=function(){
            ...
            var flag = confirm("Do You Really Want To Shift Batch ");
                if (flag == true) 
                {
                    ...
                    $scope.loading = true;
                    $http.post("http://139.59.4.32:5128/shiftBatch",batchparam)
                            .success(function (data) {
                                if (data.success == "true") {
                                    ////console.log(data);
                    ...
                    $http.post("http://139.59.4.32:5128/shiftBatchStudent",studparam)
                            .success(function (data) {
                                $scope.loading = false;
                                if (data.success == "true") {
    ...
    {
        $http.post("http://139.59.4.32:5128/getcityadmin")
        .success(function(data){
    ...
    $scope.addCityAdmin = function()
    {
        ...
        $http.post("http://139.59.4.32:5128/ad",datatosend)
        .success(function(data){
            toastr.success(data.message);
            $scope.getCities();
    ...
    else if($scope.b['branchname']==undefined || $scope.b['branchname']=="")
    {
        iziToast.error({title: 'Error',message: "Please Enter Branch Name!", position: 'bottomLeft'});
         ...
         iziToast.error({title: 'Error',message: "Please Enter Branch Contact!", position: 'bottomLeft'});
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/addbranch",datatosend)
            .success(function(data){
                $scope.loading = false;
...
/*    $scope.getCities = function()
    {
        $scope.loading = true;
        $http.get("http://139.59.4.32:5128/getcities")
        .success(function(data){
            $scope.loading = false;
           // toastr.success(data.message);
           if(data.success == "true")
     ...
     $scope.addCity = function() {
        ...
        //console.log(datatosend);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/addcity",datatosend)
        .success(function(data){
            $scope.loading = false;
            //toastr.success(data.message);
            $scope.getCities();
...
*/
    ...
    $scope.result={};
       ...
       var param=JSON.stringify({"data":data})
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getfeestructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.loading = true;
        $http.post("http://139.59.4.32:5128/FeeStructure")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
 ...
 $scope.result1={};
        ...
        $scope.getCities = function () 
      {
         ...
         $scope.getStudentInfo = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getStudentInfo",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getBoard",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     //console.log("");
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getBatch",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.getbatchesnew = function (id) {
    ...
    $scope.getCourses = function (id) {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getcourse",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     $scope.getBatches = function (name,id) {
        ...
        //console.log(param);
        $scope.loading = true;
       $http.post("http://139.59.4.32:5128/getBatches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getStaffNames = function () 
      {
        ...
        $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getstaffnames")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.templist={};
    $scope.getsmsStudentList = function () {
        ...
        /*$http.get("http://139.59.4.32:5128/getsmsStudentList")*/
    ...
    $scope.editBranch = function(branchtoupdate)
{
 ...
 $scope.updateBranch = function() {
    ...
    }else
    {
        ...
        //console.log(datatosend);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/updatebranch",datatosend)
        .success(function(data){
            $scope.loading = false;
            //console.log(data);
...
$scope.addBatch = function(branchid)
{
     if($scope.c['std']==undefined || $scope.c['std']=="")
    {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getsinglebranch",param)
        .success(function(data){
        $scope.loading = false;
        ...
        $http.post("http://139.59.4.32:5128/addbatchnew",datatosend)
        .success(function(data){
      ...
      { 
        ...
        else if($scope.usertype == "1" && $scope.branchid == undefined)
        {
          ...
          var userData = JSON.stringify({
            ...
            $http.post("http://139.59.4.32:5128/testUserExistence",userData)
            .success(function(data){
              if(data.success == "true")
              {
        alert('User Already Exists');             }
              else{
      $http.post("http://139.59.4.32:5128/insertuser",userData)
            .success(
                function (data) {
                    $scope.loading = false;
                        if (data.success === "true") {
                            ...
                            var msg ="Dear "+$scope.staffname+" Your Usernme is "+ $scope.username +" And Password is "+ $scope.password ;
                            //console.log("msg checking");
                              //console.log(msg);
                               $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+msg+'&senderId=MTEDUC&routeId=1&mobileNos='+$scope.mobile+'&smsContentType=english')
                                .success(function (data) {
                            /*//console.log($scope.mobile);
                                        $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+msg+'&senderId=MTEDUUC&routeId=1&mobileNos='+$scope.mobile+'&smsContentType=english')*/
                               /* .success(function (data) {*/
                                    if (data.responseCode == "3001") {
...
$scope.getTeachersLogin=function()
    {
        $scope.loading=true;
        $http.post("http://139.59.4.32:5128/getTeachers")
        .success(function(data){
           if(data.success == "true")
           {
    ...
    //console.log("Inside Delete Teacher");
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deleteTeacher",param)
                .success(function (data) {
                    $scope.loading = false;
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deleteuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deactivateuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("http://139.59.4.32:5128/activateuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
    ...
    {
        $scope.loading=true;
        $http.post("http://139.59.4.32:5128/getusers")
        .success(function(data){
           // toastr.success(data.message);
           if(data.success == "true")
           {
       ...
       // toastr.error("Something went wrong! Please try again...");
        ...
        $scope.getUsertypes = function() {
            //console.log("get staff names func");
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getusertypes")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
         ...
         $scope.testRegistered=function()
        {
            ...
            if ($scope.mobile && $scope.utype)
                {
                    $http.post("http://139.59.4.32:5128/registeredMobile",param)
                        .success(function (data) {
                            if (data.success == "true") {
...
$scope.toggleEditableResult = function(){
        ...
        else 
        {
           ...
           //console.log("IN function create result");
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/createbatchresult",batchdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteResult = function(id)
    {
        ...
        if (flag == true) 
        {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deleteresult",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    {
        $scope.loading = true;
            $http.post("http://139.59.4.32:5128/gettests")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getresultforstudent = function(batch) {
        //console.log(batch);
            ...
            //console.log(param);
            $http.post("http://139.59.4.32:5128/getresultforstudent",param)
                .success(function (data) {
                    if (data.success == "true") {
    ...
    $scope.getTestResultData =function()
    {
        ...
        $scope.loading = true;
            $http.post("http://139.59.4.32:5128/gettestresult",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.submitResult = function(){
        ...
        $scope.loading = true;
        //console.log(param);
        $http.post("http://139.59.4.32:5128/updatetestresult",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
     ...
     $scope.getBatchforBranchLogin =function ()
       ...
       $scope.batchforattendance = function (batchname) {
           ...
           /* var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("http://139.59.4.32:5128/getbatchattendance",param)
                .success(function (data) {
...
riddlerApp.controller('studentController', function($scope,$http,Upload,$window,$location,$route,$filter,$rootScope, idService) {
    ...
    $scope.getstd = function(board) {
        ...
        $http.post("http://139.59.4.32:5128/getstd",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log(data);
...
/*$scope.checkAllStudents = function()
    ...
    $scope.addstudentattendance = function()
    {
       ...
       angular.forEach($scope.studentList, function(student) {
                ...
                //console.log(param);
            $http.post("http://139.59.4.32:5128/studentattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    //console.log(data);
                    if (data.success == "true") {
    ...
    $scope.deleteStudent=function(){
        ...
        var param =JSON.stringify({"studId":$scope.studentInfo[0]._id})
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deletestudent",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     $scope.getStaffList = function () 
      {
        ...
        $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getstafflist",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getSubjects = function (batchname) 
      {
            ...
            $scope.topic="";
            $scope.topics={};
            $http.post("http://139.59.4.32:5128/getsubjectforbatches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.getTopics = function (batchname,subj) 
      {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/gettopicsforsubject",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.changepwd = function() {
        ...
        //console.log(param);
        $http.post("http://139.59.4.32:5128/changepwd",param)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
                     $scope.loading=false;
    ...
    $scope.savepdf = function(name,foldername){
        ...
        pdfDocGenerator.getBase64((data) => {  //alert(data);
            var pdfdata = JSON.stringify({"pdfdata":data,"pdfname":name,"foldername":foldername});
              // //console.log(pdfdata);
            $http.post("http://139.59.4.32:5128/createpdf",pdfdata)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
    ...
    for (var x = 0; x < dCount; x++) 
        ...
        if (paymentFlag == 1) 
        {
           ...
           $http.post("http://139.59.4.32:5128/editstudentinfo",param)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
                     $scope.studentInfo=data.studentdata;
     ...
     $scope.getproduct = function(board)
  {
    ...
    $scope.getenqiryperson = function (enid) {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getenqiryperson",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.getBatch = function (branchname,board) {
  ...
  $scope.selectedMonthFilter = function(element) {
    ...
    $scope.getterms=function()
    {
        //console.log("terms");
        $scope.loading = true;
         $http.post("http://139.59.4.32:5128/getterms")
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
        ...
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/addnewenquirystudent", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
                            waitingDialog.hide();
                                var msg ="Dear "+$scope.enquiry_fname+" Thanks for enquiry Mahesh Tutorials";
                                        $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+msg+'&senderId=MTEDUC&routeId=1&mobileNos='+$scope.enquiry_mobile+'&smsContentType=english')
                                .success(function (data) {
                                    if (data.responseCode == "3001") {
    ...
    $scope.deleteEnquiry = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deleteenquiry",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
$scope.loading = true;
        $http.post("http://139.59.4.32:5128/addstudentdirectly", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
                            ...
                            var msg ="Dear "+$scope.studentList.firstName+" Welcome to Mahesh Tutorial! Congratulations in your choice to focus time and energy on your own growth"
                                $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+msg+'&senderId=MTEDUC&routeId=1&mobileNos='+$scope.studentList.studentMobile+'&smsContentType=english')
                        .success(function (data) {
                            if (data.responseCode == "3001") {
...
$scope.loading = true;
        $http.post("http://139.59.4.32:5128/addnewstudent", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
    ...
    $scope.getEnquiryStudentList = function () {
        ...
        $http.post("http://139.59.4.32:5128/getEnquiryStudentList",param)
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
    ...
    $scope.getAdmittedStudentList = function () {
         $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getAdmittedStudentList")
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
    ...
    $scope.geteditdata = function () {
        //    //console.log("in fun");
          ...
          // localStorage.clear();
           ...
           $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getAdmittedStudentList",studentData)
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
        ...
        {
            //$scope.studentInfo[0].payment.push({});
            if($scope.studentInfo[0].NoOfInstallment<5)
            {
  ...
  delete($scope.studentInfo[0].payment[""+i]);
        ...
        $scope.getStudentsForAttendance = function (batchname) {
           ...
           /* var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("http://139.59.4.32:5128/getstudentslistforattendance",param)
                .success(function (data) {
        ...
        $scope.getStudents = function () {
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("http://139.59.4.32:5128/getAdmittedStudentList",param)
                .success(function (data) {
...
/*$scope.getSchools = function () {
            $http.post("http://139.59.4.32:5128/getSchoolsList")
                .success(function (data) {
                    if (data.success == "true") {
                        //console.log(data);
...
/*            //console.log("hello");
            ...
            //console.log(userData);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getschoolstudlist",userData)
               .success(function (data) {
                $scope.loading = false;
                    if (data.success == "true") {
                    //console.log(data);
      ...
      $scope.getfeedata = function(productid){
            ...
            $http.post("http://139.59.4.32:5128/getfeedata",productdata)
               .success(function (data) {
                    if (data.success == "true") {
        ...
        $scope.transferStudent = function()
        {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/transferStudent",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getcoursesbycity = function () {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getcoursesbycity",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.uploadtestfile = function() {
            ...
            var uploadUrl = "http://139.59.4.32:5128/uploadquestionpaper";
            ...
            var uploadUrl = "http://139.59.4.32:5128/uploadTimetable";
            ...
            var uploadUrl = "http://139.59.4.32:5128/uploadTimetableportion";
    ...
    else if($scope.testtimetableportionlink == undefined || $scope.testtimetableportionlink == "")
    {
        iziToast.error({title: 'Error',message: "Please Select Timetable Portion File To Upload!", position: 'bottomLeft'});
            ...
            $http.post("http://139.59.4.32:5128/uploadTestTimetable",parameter)
            .success(function(data) {
            waitingDialog.hide();
            if (data.success == "true") {
...
*/
    ...
    else if($scope.testnamefortest == undefined)
    {
        iziToast.error({title: 'Error',message: "Please Enter Test Name!", position: 'bottomLeft'});
            ...
            $http.post("http://139.59.4.32:5128/uploadTest",parameter)
            .success(function(data) {
            waitingDialog.hide();
            if (data.success == "true") {
                iziToast.success({title: 'Error',message: data.message, position: 'bottomLeft'});
    ...
    $scope.deleteTest = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deletetest",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.gettesttimetable = function () {
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/gettesttimetable")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getquestionpapers = function () {
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getquestionpapers")
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getquestionpaperforstudent = function(batch) {
            ...
            $http.post("http://139.59.4.32:5128/getquestionpaperforstudent",formdata)
                .success(function (data) {
                    if (data.success == "true") {
...
$scope.getcurrentcitystaff = function(cityid)
    {
        ...
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getCurrentCityName",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
 ...
 $scope.days=['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'];
    $scope.getTodaysTime=function (){
        ...
        $http.post("http://139.59.4.32:5128/getTodaysDate")
                        .success(function (data) {
                            if (data.success == "true") {  
                                //console.log(data);  
    ...
    $scope.applyleave=function(staffid){
        //console.log("apply leave called");
        //console.log(staffid);
        var param=JSON.stringify({"staffid": staffid});
    }
...
var i=0
  ...
  delete($scope.staffInfo[0].salarydetails.contractlist[""+i]);*/
    ...
    $scope.getStaffInfo = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getStaffInfo",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    /*  if(staffdata.salarydetails.length==undefined)
      ...
      //console.log(staffdata);
        ...
        //console.log(param);
        $scope.loading = true;
         $http.post("http://139.59.4.32:5128/editstaffinfo",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            $scope.staffInfo=data.staffdata;  
         ...
         $scope.getTeachertimetable = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getteachertimetable",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getStaffAttendancedetails = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getstaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
...
//console.log("get emplyee attendance details called");
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getstaffpayment = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/summarypayment",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    alert (minutes+' minutes.');
      ...
      /*  var a = moment.duration(start, 'H');
        ...
        //$location.path('adminDashboard');
    $scope.loading = true;
    $http.post("http://139.59.4.32:5128/addstaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data.staff);
...
$scope.saveEmployeeAttendance = function () {
        ...
        //$location.path('adminDashboard');
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/addemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
   ...
   $scope.saveupdatedAttendance=function(){
    ...
    //console.log($scope.updatedata);
        ...
        */
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/updatestaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    //console.log("success");
    ...
    //console.log($scope.employeedata);
        ...
        */
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/updateemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.getEmployeeList = function () 
      {
        ...
        //console.log('city stafflist :'+param);
        $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getemployeelist",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getSubjects = function (batchname) 
        ...
        $scope.getTopics = function (batchname,subj) 
      {
         ...
         $scope.getStaffDetails = function () {
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getBranchStaffList")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.insertStaff = function (id) {    
    ...
    var staffData = JSON.stringify({"staffdata":$scope.stafflist});
        ...
        $scope.loading = true;
        waitingDialog.show("...Please Wait");
        $http.post("http://139.59.4.32:5128/addstaff", staffData)
            .success(
                function (data) {
                    $scope.loading = false;
                        if (data.success === "true") {
...
/*
    ...
    $scope.deleteStaff = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deletestaff",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
riddlerApp.controller('rfidController', function($scope,$http,$window) 
{
    ...
    {
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getBatches")
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    $scope.getRfidList = function(){
        ...
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getassignedrfid",param)
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    $scope.saveRfidList = function()
    {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/updaterfidlist",param)
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
...
riddlerApp.controller('feesController', function($scope,$http,$window,$location,$route) 
{
    ...
    $scope.getCount = function(){
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/feereportcount")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
   ...
   /*  param=JSON.stringify({"data":feesdata});
      ...
      $scope.loading = true;
    $http.post("http://139.59.4.32:5128/FeeStructure",feesdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
   ...
   var feesdata=JSON.stringify({"id":productid});
    ...
    $scope.exportDiscount=function(name = '')
    {
     ...
     $scope.insertnewstructure = function () {
        ...
        //console.log(param);
       $scope.loading = true;
    $http.post("http://139.59.4.32:5128/insertnewstructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                     iziToast.show({theme: 'dark',title:'Success',message: data.message,position: 'bottomLeft',icon: 'fa fa-user',progressBarColor: 'rgb(0, 255, 184)'});  
    ...
    {
        $scope.loading = true;
      $http.post("http://139.59.4.32:5128/getallbranches")
        .success(function(data){
           // toastr.success(data.message);
           $scope.loading = false;
           if(data.success == "true")
  ...
  $scope.getBatch = function (branchname,board) {
   ...
   $scope.getClassFee = function () {
        ...
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getclassfeetructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
/*       data={};
    ...
    //console.log(param);
        ...
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/updatefeeinfo",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteFeeStructure = function(fee_id)
    {
        ...
        if (flag == true) 
        {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deletefeestructure",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
riddlerApp.controller('scheduleController', function($scope,$http,$window,$location,$route) 
{
    ...
    $scope.editYearlySchedulebatch = function(){
        ...
        //waitingDialog.show('...Please Wait');
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/editYearlySchedulebatch",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.submitYearlySchedule = function(){
        ...
        //waitingDialog.show('...Please Wait');
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/editYearlySchedule",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.getSchedules = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getSchedules")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getSchedules",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $http.post("http://139.59.4.32:5128/getColors")
    ...
    $scope.getdashschedule = function () {
        ...
        $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getdashschedule",formdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        $http.post("http://139.59.4.32:5128/getColors")
    ...
    $scope.createSchedule = function(){
        ...
        else 
        {
           ...
           //waitingDialog.show('...Please Wait');
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/createschedule",scheduleDates)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteSchedule = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deleteschedule",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
     ...
     $scope.addcolor = function(){
      ...
      $scope.loading = true;
        $http.post("http://139.59.4.32:5128/addColor",colorData)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $route.reload();
    ...
    $scope.createTimetable = function() {
        ...
        //console.log(ttData);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/createtimetable",ttData)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            //console.log(data);
                            ...
                            iziToast.error({title: 'Error',message: data.reason, position: 'bottomLeft'});
                        }
    ...
    $scope.newcreateTimetable = function() {
        ...
        //console.log(ttData);
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/chktimetableexist",ttData)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                                          $http.post("http://139.59.4.32:5128/newcreatetimetable",ttData)
                                        .success(function (data) {
                                            $scope.loading = false;
                                            if (data.success == "true") {
                                                //console.log(data);
      ...
      /*  $scope.allsyll[0].syllabus.subject.splice(localStorage.subjectindex, 1); 
        ...
        //console.log("param");
        //console.log(param);
        $http.post("http://139.59.4.32:5128/editDailyTimetable",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
        ...
        $scope.getmo=function(param,msg){
                    $http.post("http://139.59.4.32:5128/getteachermobile",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                        $http.get('http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=d47cccfbcc9269f165cc8718bd82a2c&message='+msg+'&senderId=MTEDUC&routeId=1&mobileNos='+'9960136918'+'&smsContentType=english')
                        .success(function (data) {
                            if (data.responseCode == "3001") {
...
/*          var startTime=moment($scope.newtt[index].stime, "HH:mm a");
    ...
    $scope.getTimetable = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getTimetable")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.alltt = data.timetables;
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getTimetable",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    /*$http.post("http://139.59.4.32:5128/getColors")
    ...
    $scope.newgetTimetable = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/newgetTimetable")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.alltt = data.timetables;
            ...
            var id = JSON.stringify({"id":localStorage.timetableID});
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/newgetTimetable",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    /*$http.post("http://139.59.4.32:5128/getColors")
    ...
    $scope.gettodaystimetable = function ()
    {
        ...
        $http.post("http://139.59.4.32:5128/gettodaystimetable",formdata)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log(data);
            ...
            .success(function (data) {
                ...
                if (data.success == "true") {
                    ...
                    if (data.overlap == "false") {
                        ...
                        //console.log(param2);
                        $http.post("http://139.59.4.32:5128/updatetimetable",param2)
                            .success(function (data) {
                            if (data.success == "true") {
                            //console.log("success");
                            /*//console.log(data);
    ...
    $scope.getBoard = function () {
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getBoard")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.createSyllabus = function() {
      ...
      var param = JSON.stringify({'syllName': $scope.syllName,'syllyear': $scope.syllyear});
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/createSyllabus",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            ////console.log(data);
    ...
    $scope.deleteSyllabus = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deletesyllabus",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.deleteTimeTable = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/deletetimetable",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.getSyllabus = function(id = '') {
      if (id == '') {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getSyllabus")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getSyllabus",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
...
/*    $scope.subject = [];*/
    ...
    $scope.addsubjectinsyll = function() {
       ...
       $scope.allsyll[0].syllabus.subject.push({"subject":$scope.newsubject,"topic":[]});
    ...
    $scope.savesyllabus=function()
    {
          ...
          //var param = JSON.parse( angular.toJson({"schedules" :$scope.schedules}));
        var syllabusdata = JSON.parse(angular.toJson({"syllabus":$scope.allsyll}));
            $scope.loading = true;
            //console.log(syllabusdata);
            $http.post("http://139.59.4.32:5128/updatesyllabus",syllabusdata)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    {
        $scope.allsyll[0].syllabus.subject[subjectindex].topic.splice(topicindex, 1); 
    }

    $scope.deletesubject = function()
    {
        //console.log(localStorage.subjectindex);
        //console.log($scope.allsyll[0].syllabus);
        $scope.allsyll[0].syllabus.subject.splice(localStorage.subjectindex, 1);
        this.setState($scope.allsyll[0].syllabus.subject);
        //localStorage.subjectindex = localStorage.subjectindex - 1;
        //$scope.allsyll[0].syllabus=$scope.allsyll[0].syllabus;
       // $route.reload();
    }
    ...
    {
         $http.post("http://139.59.4.32:5128/getsyllabusname")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.createdailyreport = function()
    {
        ...
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/createdailyreport",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == 'true') {
                    setTimeout($scope.getdailyreport,1000);
                } else {
    ...
    $scope.getdailyreport = function(id = '') {
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getdailyreport")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("http://139.59.4.32:5128/getdailyreport",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    {
       $http.get("http://139.59.4.32:5128/getdailyreportcolor")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.lecturerecord = function ()
    {
        ...
        $scope.loading = true;
        $http.post("http://139.59.4.32:5128/getlecturedetails",senddata)
            .success(function(data){
                $scope.loading = false;
           if(data.success == "true")
           {

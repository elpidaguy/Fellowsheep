  ...
  return {
   ...
   riddlerApp.service('idService', function() {
    ...
    riddlerApp.config(function($routeProvider) {
        $routeProvider
            ...
            .when('/parentsfeedback',{
                templateUrl : 'app/parentsfeedback.html',
                controller : 'homeController'
                })
            ;
    });
    ...
    $scope.logout = function (path) {
        ...
        $scope.getBranchFeedback = function()
        {
            var currentLoginData = JSON.parse(localStorage.getItem('loginData'));
            console.log(currentLoginData.branchid);
            var param = JSON.stringify({
                        "branchid" : currentLoginData.branchid
                    });

            $http.post("https://espl.in.net/mainapi/getfeedbacksbybranch",param)
         ...
         $scope.getfeedbackstatus = function() {
            console.log("yo getfeedbackstatus");

            $http.get("https://espl.in.net/mainapi/getfeedbackstatus")
                        .success(function (data) {
                            $scope.loading = false;
                            if (data.success == "true") {
                                console.log(data.feedbackbutton.visible);
                                if(data.feedbackbutton.visible=="on")
                                {
                                     $scope.feedback=true;
                                }else{
        ...
        $scope.doLogin = function () {
            ...
            /*else if($scope.usertype == undefined || $scope.usertype =="blank")
            {
                ...
                iziToast.error({title: 'Error',message: "Please select user type", position: 'bottomLeft'});
                        ...
                        $scope.loading = true;
                    $http.post("https://espl.in.net/mainapi/doLogin",userData)
                        .success(function (data) {
                            $scope.loading = false;
                            if (data.success == "true") {
                                ////console.log(data.data[0]);
            ...
            bothsmslist=bothsmslist+checkedSmsList[checkedSmsList.length-1].studentMobile; 
             mobilenos=bothsmslist
                    ...
                    var smsdata = JSON.stringify({"mobile":mobilenos,"msg":$scope.sms});
                            $http.post("https://espl.in.net/mainapi/sendsms",smsdata)
                            .success(function (data) {
                                if(data.success=="true")
                                {
 ...
 //var param=JSON.stringify({});
  /*          var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;*/
            $http.get("https://espl.in.net/mainapi/getStudentListforrfids")
                .success(function (data) {
            ...
            $http.get("https://espl.in.net/mainapi/getrfidforassignment")
                .success(function (data) {
          ...
          $scope.assignRFID = function () {
            ...
            $http.post("https://espl.in.net/mainapi/assignRFID",param)
                .success(function (data) {
 ...
 //var param=JSON.stringify({});
  /*          var name = localStorage.batchname;
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getallbranches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getcoursesnew",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.shiftBatch=function(){
            ...
            var flag = confirm("Do You Really Want To Shift Batch ");
                if (flag == true) 
                {
                    ...
                    $scope.loading = true;
                    $http.post("https://espl.in.net/mainapi/shiftBatch",batchparam)
                            .success(function (data) {
                                if (data.success == "true") {
                                    ////console.log(data);
                    ...
                    $http.post("https://espl.in.net/mainapi/shiftBatchStudent",studparam)
                            .success(function (data) {
                                $scope.loading = false;
                                if (data.success == "true") {
    ...
    {
        $http.post("https://espl.in.net/mainapi/getcityadmin")
        .success(function(data){
    ...
    $scope.addCityAdmin = function()
    {
        ...
        $http.post("https://espl.in.net/mainapi/ad",datatosend)
        .success(function(data){
            toastr.success(data.message);
            $scope.getCities();
    ...
    else if($scope.b['branchname']==undefined || $scope.b['branchname']=="")
    {
        iziToast.error({title: 'Error',message: "Please Enter Branch Name!", position: 'bottomLeft'});
         ...
         iziToast.error({title: 'Error',message: "Please Enter Branch Contact!", position: 'bottomLeft'});
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/addbranch",datatosend)
            .success(function(data){
                $scope.loading = false;
...
/*    $scope.getCities = function()
    {
        $scope.loading = true;
        $http.get("https://espl.in.net/mainapi/getcities")
        .success(function(data){
            $scope.loading = false;
           // toastr.success(data.message);
           if(data.success == "true")
     ...
     $scope.addCity = function() {
        ...
        //console.log(datatosend);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/addcity",datatosend)
        .success(function(data){
            $scope.loading = false;
            //toastr.success(data.message);
            $scope.getCities();
...
*/
    ...
    $scope.result={};
       ...
       var param=JSON.stringify({"data":data})
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getfeestructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.loading = true;
        $http.post("https://espl.in.net/mainapi/FeeStructure")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
 ...
 $scope.result1={};
        ...
        $scope.getCities = function () 
      {
         ...
         $scope.getStudentInfo = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getStudentInfo",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getBoard",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     //console.log("");
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getBatch",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.getbatchesnew = function (id) {
    ...
    $scope.getCourses = function (id) {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getcourse",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        console.log(data);
     ...
     $scope.getBatches = function (name,id) {
        ...
        //console.log(param);
        $scope.loading = true;
       $http.post("https://espl.in.net/mainapi/getBatches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getStaffNames = function () 
      {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getstaffnames")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.templist={};
    ...
    $http.get("https://espl.in.net/mainapi/getsmsStudentList")
      ...
      $scope.getStaffDetails = function () {
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getBranchStaffList")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.editBranch = function(branchtoupdate)
{
 ...
 $scope.updateBranch = function() {
    ...
    }else
    {
        ...
        //console.log(datatosend);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/updatebranch",datatosend)
        .success(function(data){
            $scope.loading = false;
            //console.log(data);
...
$scope.addBatch = function(branchid)
{
     ...
     if($scope.c['std']==undefined || $scope.c['std']=="")
    {
        ...
        $scope.branchid = localStorage.branchId;

        $scope.c["branchid"]=$scope.branchid;
        
        var bdetails={};
        var param =JSON.stringify({"branchid":$scope.branchid});
        
        console.log(param);
        
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getsinglebranch",param)
        .success(function(data){
        $scope.loading = false;
        ...
        $http.post("https://espl.in.net/mainapi/addbatchnew",datatosend)
        .success(function(data){
      ...
      { 
        ...
        else if($scope.usertype == "1" && $scope.branchid == undefined)
        {
          ...
          var userData = JSON.stringify({
            ...
            $http.post("https://espl.in.net/mainapi/testUserExistence",userData)
            .success(function(data){
              if(data.success == "true")
              {
        alert('User Already Exists');             }
              else{
      $http.post("https://espl.in.net/mainapi/insertuser",userData)
            .success(
                function (data) {
                    $scope.loading = false;
                        if (data.success === "true") {
...
$scope.getTeachersLogin=function()
    {
        $scope.loading=true;
        $http.post("https://espl.in.net/mainapi/getTeachers")
        .success(function(data){
           if(data.success == "true")
           {
    ...
    //console.log("Inside Delete Teacher");
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deleteTeacher",param)
                .success(function (data) {
                    $scope.loading = false;
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deleteuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deactivateuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
        ...
        //console.log(param);
             $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/activateuser",param)
                .success(function (data) {
                    $scope.loading = false;
                    $scope.getusers();
                    if (data.success == "true") {
    ...
    {
        $scope.loading=true;
        $http.post("https://espl.in.net/mainapi/getusers")
        .success(function(data){
           // toastr.success(data.message);
           if(data.success == "true")
           {
       ...
       // toastr.error("Something went wrong! Please try again...");
        ...
        $scope.getUsertypes = function() {
            //console.log("get staff names func");
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getusertypes")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
         ...
         $scope.testRegistered=function()
        {
            ...
            if ($scope.mobile && $scope.utype)
                {
                    $http.post("https://espl.in.net/mainapi/registeredMobile",param)
                        .success(function (data) {
                            if (data.success == "true" ) {
...
$scope.toggleEditableResult = function(){
        ...
        else 
        {
           ...
           //console.log("IN function create result");
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/createbatchresult",batchdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteResult = function(id)
    {
        ...
        if (flag == true) 
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deleteresult",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    {
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/gettests")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getresultforstudent = function(batch) {
        //console.log(batch);
            ...
            //console.log(param);
            $http.post("https://espl.in.net/mainapi/getresultforstudent",param)
                .success(function (data) {
                    if (data.success == "true") {
    ...
    $scope.getTestResultData =function()
    {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/gettestresult",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.submitResult = function(){
        ...
        $scope.loading = true;
        //console.log(param);
        $http.post("https://espl.in.net/mainapi/updatetestresult",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
     ...
     $scope.getBatchforBranchLogin =function ()
       ...
       $scope.batchforattendance = function (batchname) {
           ...
           /* var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("https://espl.in.net/mainapi/getbatchattendance",param)
                .success(function (data) {
...
riddlerApp.controller('studentController', function($scope,$http,Upload,$window,$location,$route,$filter,$rootScope, idService) {
    ...
    $scope.getstd = function(board) {
        ...
        $http.post("https://espl.in.net/mainapi/getstd",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log(data);
...
/*$scope.checkAllStudents = function()
    ...
    $scope.addstudentattendance = function()
    {
       ...
       angular.forEach($scope.studentList, function(student) {
                ...
                //console.log(param);
            $http.post("https://espl.in.net/mainapi/studentattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    //console.log(data);
                    if (data.success == "true") {
    ...
    $scope.deleteStudent=function(){
        ...
        var param =JSON.stringify({"studId":$scope.studentInfo[0]._id})
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deletestudent",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
     ...
     $scope.getStaffList = function () 
      {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getstafflistall")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getSubjects = function (batchname) 
      {
            ...
            $scope.topic="";
            $scope.topics={};
            $http.post("https://espl.in.net/mainapi/getsubjectforbatches",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.getTopics = function (batchname,subj) 
      {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/gettopicsforsubject",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.changepwd = function() {
        ...
        //console.log(param);
        $http.post("https://espl.in.net/mainapi/changepwd",param)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
                     $scope.loading=false;
    ...
    $scope.savepdf = function(name,foldername){
        ...
        pdfDocGenerator.getBase64((data) => {  //alert(data);
            var pdfdata = JSON.stringify({"pdfdata":data,"pdfname":name,"foldername":foldername});
              // //console.log(pdfdata);
            $http.post("https://espl.in.net/mainapi/createpdf",pdfdata)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
...
{
    console.log('inside save edited fees');

    console.log($scope.studentInfo[0]);
    paymentFlag = 0;
    toCheck=$scope.studentInfo[0].total;
    totalToCheck=0;
    dCount=parseInt($scope.studentInfo[0].NoOfInstallment);
    ...
    checkflag=true;
        ...
        {
            // console.log(x);
            // console.log($scope.studentInfo[0].payment[x].mode);
            ...
            if(x == parseInt(dCount)-1)
            {
                console.log('in x count');
               if(checkflag&&ddflag&&cashflag)
                {
                    ...
                    if (totalToCheck == toCheck) 
                    {
                        ...
                        console.log('in else payment flag');
        ...
        if (paymentFlag == 1) 
        {
           ...
           studedata=$scope.studentInfo[0];
            ...
            console.log(param);
            $scope.loading = true;
           $http.post("https://espl.in.net/mainapi/editstudentinfo",param)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log("success");
                     $scope.studentInfo=data.studentdata;
 ...
 /*   $scope.saveEditedFees=function()
     ...
     $scope.getproduct = function(board)
  {
    ...
    $scope.getenqiryperson = function (enid) {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getenqiryperson",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.getBatch = function (branchname,board) {
  ...
  $scope.selectedMonthFilter = function(element) {
    ...
    $scope.getterms=function()
    {
        //console.log("terms");
        $scope.loading = true;
         $http.post("https://espl.in.net/mainapi/getterms")
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/addnewenquirystudent", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
    ...
    $scope.deleteEnquiry = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deleteenquiry",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
$scope.loading = true;
        $http.post("https://espl.in.net/mainapi/addstudentdirectly", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
...
$scope.loading = true;
        $http.post("https://espl.in.net/mainapi/addnewstudent", studentData)
                .success(
                    function (data) {
                        $scope.loading = false;
                        if (data.success === "true") {
    ...
    $scope.getEnquiryStudentList = function () {
        ...
        $http.post("https://espl.in.net/mainapi/getEnquiryStudentList",param)
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
    ...
    $scope.getAdmittedStudentList = function () {
         $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getAdmittedStudentList")
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
    ...
    $scope.geteditdata = function () {
        //    //console.log("in fun");
          ...
          // localStorage.clear();
           ...
           $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getAdmittedStudentList",studentData)
            .success(
                function (data) {
                    $scope.loading = false;
                    if (data.success === "true"){
  ...
  // {
  //    $http.post("http://127.0.0.1:5000/login",JSON.stringify($scope.form2))
  //   .success(function(data){
  //     if(data.token){
  ...
  //    })
        ...
        $scope.getStudentsForAttendance = function (batchname) {
           ...
           /* var name = localStorage.batchname;
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("https://espl.in.net/mainapi/getstudentslistforattendance",param)
                .success(function (data) {
        ...
        $scope.getStudents = function () {
            ...
            //console.log(param);
            $scope.loading=true;
            $http.post("https://espl.in.net/mainapi/getAdmittedStudentList",param)
                .success(function (data) {
...
/*$scope.getSchools = function () {
            $http.post("https://espl.in.net/mainapi/getSchoolsList")
                .success(function (data) {
                    if (data.success == "true") {
                        //console.log(data);
...
/*            //console.log("hello");
            ...
            //console.log(userData);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getschoolstudlist",userData)
               .success(function (data) {
                $scope.loading = false;
                    if (data.success == "true") {
                    //console.log(data);
      ...
      $scope.getfeedata = function(productid){
            ...
            $http.post("https://espl.in.net/mainapi/getfeedata",productdata)
               .success(function (data) {
                    if (data.success == "true") {
        ...
        $scope.getTotalRollNumbers = function(batch)
        {
        	console.log(batch);
        	var param = JSON.stringify({"Batch":batch});
        	$http.post("https://espl.in.net/mainapi/getTotalRollNumbers",param)
        	.success(function(data) {
        		if (data.success == "true") {
        ...
        $scope.transferStudent = function()
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/transferStudent",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getcoursesbycity = function () {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getcoursesbycity",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
        ...
        $scope.uploadtestfile = function() {
            ...
            var uploadUrl = "https://espl.in.net/mainapi/uploadquestionpaper";
            ...
            var uploadUrl = "https://espl.in.net/mainapi/uploadTimetable";
            ...
            var uploadUrl = "https://espl.in.net/mainapi/uploadTimetableportion";
    ...
    else if($scope.testtimetableportionlink == undefined || $scope.testtimetableportionlink == "")
    {
        iziToast.error({title: 'Error',message: "Please Select Timetable Portion File To Upload!", position: 'bottomLeft'});
            ...
            $http.post("https://espl.in.net/mainapi/uploadTestTimetable",parameter)
            .success(function(data) {
            waitingDialog.hide();
            if (data.success == "true") {
...
*/
     ...
     else if($scope.questionpaperlink == undefined)
    {
        iziToast.error({title: 'Error',message: "Please Select File!", position: 'bottomLeft'});
            ...
            $http.post("https://espl.in.net/mainapi/uploadTest",parameter)
            .success(function(data) {
            waitingDialog.hide();
            if (data.success == "true") {
                iziToast.success({title: 'Error',message: data.message, position: 'bottomLeft'});
    ...
    $scope.deleteTest = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deletetest",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.gettesttimetable = function () {
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/gettesttimetable")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getquestionpapers = function () {
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getquestionpapers")
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getquestionpaperforstudent = function(batch) {
            ...
            $http.post("https://espl.in.net/mainapi/getquestionpaperforstudent",formdata)
                .success(function (data) {
                    if (data.success == "true") {
    ...
    $scope.showeditables = localStorage.showeditables;
     $scope.loginAuth = function() {
        ...
        else if($scope.sTime == undefined)
        {
            ...
            $scope.loading=true;
            $http.post("https://espl.in.net/mainapi/markEmpAttendance",param)
                .success(function (data) {
                    if (data.success == "true") {
                    $scope.loading=false;
                    console.log("success");
...
$scope.getcurrentcitystaff = function(cityid)
    {
        ...
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getCurrentCityName",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
 ...
 $scope.days=['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'];
    $scope.getTodaysTime=function (){
        ...
        $http.post("https://espl.in.net/mainapi/getTodaysDate")
                        .success(function (data) {
                            if (data.success == "true") {  
                                //console.log(data);  
    ...
    $scope.applyleave=function(staffid,stafffname,staffmname,stafflname,staffmobile)
    {
        ...
        $http.post("https://espl.in.net/mainapi/addApplyleave",param)
            .success(function (data) {
                if (data.success == 'true') {
...
var i=0
  ...
  delete($scope.staffInfo[0].salarydetails.contractlist[""+i]);*/
    ...
    $scope.getStaffInfo = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getStaffInfo",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    /*  if(staffdata.salarydetails.length==undefined)
      ...
      //console.log(staffdata);
        ...
        //console.log(param);
        $scope.loading = true;
         $http.post("https://espl.in.net/mainapi/editstaffinfo",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            $scope.staffInfo=data.staffdata;  
         ...
         $scope.getTeachertimetable = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getteachertimetable",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getStaffAttendancedetails = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getstaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    $scope.staffAttendanceInfo = data.lectures.reverse();
                    //console.log(data);
...
//console.log("get emplyee attendance details called");
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getEmpAttendance = function()
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getempattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getstaffRfidattendance = function()
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getstaffRfidattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
        ...
        $scope.getstaffpayment = function () {
            ...
            //console.log(param);
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/summarypayment",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    alert (minutes+' minutes.');
      ...
      /*  var a = moment.duration(start, 'H');
        ...
        // $scope.subject = "Supervision";
        // $scope.topic = "Supervision";
        ...
        //$location.path('adminDashboard');
    $scope.loading = true;
    $http.post("https://espl.in.net/mainapi/addstaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data.staff);
    ...
    $scope.saveSupervisorAttendance = function () {
       if($scope.staffid == undefined || $scope.staffid == "")
        {
            iziToast.error({title: 'Error',message: "Please select Staff", position: 'bottomLeft'});
...
$scope.saveEmployeeAttendance = function () {
    console.log($scope.today);
        ...
        //$location.path('adminDashboard');
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/addemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        var msg = " You conducted lecture of "+ $scope.subject+" from "+ start+" to "+ end +" on " +$scope.today+" . ";
   ...
   $scope.saveupdatedAttendance=function(){
    ...
    //console.log($scope.updatedata);
        ...
        */
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/updatestaffattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    //console.log("success");
    ...
    //console.log($scope.employeedata);
        ...
        */
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/updateemployeeattendance",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.getStaffList = function () 
      {
        ...
        //console.log('city stafflist :'+param);
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getstafflistall",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.getEmployeeList = function () 
      {
        ...
        //console.log('city stafflist :'+param);
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getemployeelist",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
$scope.insertStaff = function (id) {    
    ...
    var staffData = JSON.stringify({"staffdata":$scope.stafflist});
        ...
        $scope.loading = true;
        waitingDialog.show("...Please Wait");
        $http.post("https://espl.in.net/mainapi/addstaff", staffData)
            .success(
                function (data) {
                    $scope.loading = false;
                        if (data.success === "true") {
...
/*
    ...
    $scope.deleteStaff = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deletestaff",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.deleteattendance = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deleteattendance",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
riddlerApp.controller('rfidController', function($scope,$http,$window) 
{
    ...
    {
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getBatches")
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    {
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getStaffListRfid")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    $scope.assignStaffRfid = function()
    {
        ...
        console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/assignrfidforstaff",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                    iziToast.show({theme: 'dark',title:'Success',message: data.message,position: 'bottomLeft',icon: 'fa fa-user',progressBarColor: 'rgb(0, 255, 184)'});  
    ...
    $scope.getRfidList = function(){
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getassignedrfid",param)
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
    ...
    $scope.saveRfidList = function()
    {
        ...
        //console.log(param);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/updaterfidlist",param)
                .success(function (data) {
                    //console.log(data);
                    $scope.loading = false;
                    if (data.success == "true") {
...
riddlerApp.controller('feesController', function($scope,$http,$window,$location,$route) 
{
    ...
    $scope.getCount = function(){
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/feereportcount")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
   ...
   /*  param=JSON.stringify({"data":feesdata});
      ...
      $scope.loading = true;
    $http.post("https://espl.in.net/mainapi/FeeStructure",feesdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
   ...
   var feesdata=JSON.stringify({"id":productid});
    ...
    $scope.exportDiscount=function(name = '')
    {
     ...
     $scope.insertnewstructure = function () {
        ...
        //console.log(param);
       $scope.loading = true;
    $http.post("https://espl.in.net/mainapi/insertnewstructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                     iziToast.show({theme: 'dark',title:'Success',message: data.message,position: 'bottomLeft',icon: 'fa fa-user',progressBarColor: 'rgb(0, 255, 184)'});  
    ...
    {
        $scope.loading = true;
      $http.post("https://espl.in.net/mainapi/getallbranches")
        .success(function(data){
           // toastr.success(data.message);
           $scope.loading = false;
           if(data.success == "true")
  ...
  $scope.getBatch = function (branchname,board) {
   ...
   $scope.getClassFee = function () {
        ...
        waitingDialog.show('...Please Wait ');
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getclassfeetructure",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
...
/*       data={};
    ...
    //console.log(param);
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/updatefeeinfo",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteFeeStructure = function(fee_id)
    {
        ...
        if (flag == true) 
        {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deletefeestructure",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
...
riddlerApp.controller('scheduleController', function($scope,$http,$window,$location,$route) 
{
    ...
    $scope.countDashboard = function()
    {
        ...
        $http.post("https://espl.in.net/mainapi/countDashboard")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log(data);
    ...
    $scope.editYearlySchedulebatch = function(){
        ...
        //waitingDialog.show('...Please Wait');
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/editYearlySchedulebatch",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.submitYearlySchedule = function(){
        ...
        //waitingDialog.show('...Please Wait');
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/editYearlySchedule",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
    ...
    $scope.getSchedules = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getSchedules")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getSchedules",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $http.post("https://espl.in.net/mainapi/getColors")
    ...
    $scope.getdashschedule = function () {
        ...
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getdashschedule",formdata)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        $http.post("https://espl.in.net/mainapi/getColors")
    ...
    $scope.createSchedule = function(){
        ...
        else 
        {
           ...
           //waitingDialog.show('...Please Wait');
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/createschedule",scheduleDates)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.deleteSchedule = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deleteschedule",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
     ...
     $scope.addcolor = function(){
      ...
      $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/addColor",colorData)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $route.reload();
    ...
    //     //console.log(ttData);
    //     $scope.loading = true;
    //     $http.post("https://espl.in.net/mainapi/createtimetable",ttData)
    //                 .success(function (data) {
    //                     $scope.loading = false;
    //                     if (data.success == "true") {
    //                         //console.log(data);
    ...
    $scope.newcreateTimetable = function() {
        ...
        console.log(ttData);
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/chktimetableexist",ttData)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                                          $http.post("https://espl.in.net/mainapi/newcreatetimetable",ttData)
                                        .success(function (data) {
                                            $scope.loading = false;
                                            if (data.success == "true") {
                                                //console.log(data);
      ...
      /*  $scope.allsyll[0].syllabus.subject.splice(localStorage.subjectindex, 1); 
        ...
        //console.log("param");
        //console.log(param);
        $http.post("https://espl.in.net/mainapi/editDailyTimetable",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    //console.log("success");
        ...
        $scope.getmo=function(param,msg){
                    $http.post("https://espl.in.net/mainapi/getteachermobile",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            console.log(data);
...
/*          var startTime=moment($scope.newtt[index].stime, "HH:mm a");
    ...
    $scope.getTimetable = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getTimetable")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.alltt = data.timetables;
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getTimetable",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    /*$http.post("https://espl.in.net/mainapi/getColors")
    ...
    $scope.newgetTimetable = function(id = ''){
        ...
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/newgetTimetable")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.alltt = data.timetables;
            ...
            var id = JSON.stringify({"id":localStorage.timetableID});
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/newgetTimetable",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    /*$http.post("https://espl.in.net/mainapi/getColors")
    ...
    $scope.gettodaystimetable = function ()
    {
        ...
        $http.post("https://espl.in.net/mainapi/gettodaystimetable",formdata)
            .success(function (data) {
                if (data.success == "true") {
                    //console.log(data);
            ...
            .success(function (data) {
                ...
                if (data.success == "true") {
                    ...
                    if (data.overlap == "false") {
                        ...
                        //console.log(param2);
                        $http.post("https://espl.in.net/mainapi/updatetimetable",param2)
                            .success(function (data) {
                            if (data.success == "true") {
                            //console.log("success");
                            /*//console.log(data);
    ...
    $scope.getBoard = function () {
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getBoard")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.createSyllabus = function() {
      ...
      var param = JSON.stringify({'syllName': $scope.syllName,'syllyear': $scope.syllyear});
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/createSyllabus",param)
                    .success(function (data) {
                        $scope.loading = false;
                        if (data.success == "true") {
                            ////console.log(data);
    ...
    $scope.deleteSyllabus = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deletesyllabus",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.deleteTimeTable = function(id)
    {
        ...
        if (flag == true) 
        {
            var param=JSON.stringify({"id": id})
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/deletetimetable",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") 
                {
    ...
    $scope.getSyllabus = function(id = '') {
      ...
      if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getSyllabus")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getSyllabus",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
...
/*    $scope.subject = [];*/
    ...
    $scope.savesyllabus=function()
    {
        ...
        var syllabusdata = JSON.parse(angular.toJson({"syllabus":$scope.syll}));
            ...
            $http.post("https://espl.in.net/mainapi/updatesyllabus",syllabusdata)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.getsyllabusname = function()
    {
        console.log("inside getsyllabusname");
         $http.post("https://espl.in.net/mainapi/getsyllabusname")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.createdailyreport = function()
    {
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/createdailyreport",param)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == 'true') {
                    $scope.syllName="";
    ...
    $scope.getdailyreport = function(id = '') {
        if (id == '') {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getdailyreport")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getdailyreport",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
        ...
        if (id == '') {
            //console.log('in if of getdailyreport');
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getnewdailyreport")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                    $scope.dailyreport = data.dailyreport;
            ...
            $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getnewdailyreport",id)
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
                        $scope.onedailyreport = data.dailyreport;
    ...
    $scope.getdashdailyreport = function() {
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getdashdailyreport",id)
        .success(function (data) {
            $scope.loading = false;
            if (data.success == "true") {
                    $scope.onedailyreport = data.dailyreport;
  ...
  /*  $scope.getdailyreportcolor=function()
    {
       $http.get("https://espl.in.net/mainapi/getdailyreportcolor")
            .success(function (data) {
                $scope.loading = false;
                if (data.success == "true") {
    ...
    $scope.lecturerecord = function ()
    {
        ...
        $scope.loading = true;
        $http.post("https://espl.in.net/mainapi/getlecturedetails",senddata)
            .success(function(data){
                $scope.loading = false;
           if(data.success == "true")
           {
    ...
    $scope.getLeavelist = function () 
      {
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/getLeavelist")
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        //console.log(data);
    ...
    $scope.leaveaction = function (idd,staffid,action,staffmobile)
    {
        console.log(staffid,action);
      //  var param=JSON.stringify({"staffid": staffid,"leavedate": leavedate, "action":action});
       var param=JSON.stringify({"_id": idd,"staffid": staffid,"action":action});
        $scope.loading = true;
            $http.post("https://espl.in.net/mainapi/leaveaction",param)
                .success(function (data) {
                    $scope.loading = false;
                    if (data.success == "true") {
                        iziToast.show({theme: 'dark',title:'Success',message: data.message,position: 'bottomLeft',icon: 'fa fa-user',progressBarColor: 'rgb(0, 255, 184)'});

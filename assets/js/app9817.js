...
$scope.getbranches = function()
{
  ...
  $http.post("http://210.212.181.86:5127/getallbranches")
...
{
    $http.post("http://210.212.181.86:5127/getcityadmin")
    .success(function(data){
       // toastr.success(data.message);
       if(data.success == "true")
       {
...
$scope.addCityAdmin = function()
{
    ...
    $http.post("http://210.212.181.86:5127/ad",datatosend)
    .success(function(data){
        toastr.success(data.message);
        $scope.getCities();
...
$scope.addBranch = function()
{
    ...
    $http.post("http://210.212.181.86:5127/addbranch",datatosend)
    .success(function(data){
        toastr.success(data.message);
        $scope.getbranches();
...
{
    $http.post("http://210.212.181.86:5127/getcities")
    .success(function(data){
       // toastr.success(data.message);
       if(data.success == "true")
       {
...
$scope.addCity = function() {
    ...
    $http.post("http://210.212.181.86:5127/addcity",datatosend)
    .success(function(data){
        toastr.success(data.message);
        $scope.getCities();
    })  
...
app.controller('feesController', function ($scope, $http) {
    ...
    $scope.getAllFees = function () {
        ...
        $http.post("http://210.212.181.86:5127/getfeestructure",param)
                .success(function (data) {
                    if (data.success == "true") {
                        console.log(data);
                        $scope.result=data;
    ...
    console.log(param);
        ...
        $http.post("http://210.212.181.86:5127/updatefeeinfo",param)
                .success(function (data) {
                    if (data.success == "true") {
                        console.log(data);
                        $scope.result=data;
